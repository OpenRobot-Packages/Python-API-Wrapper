...
class Forbidden(OpenRobotAPIError):
    """Received an 403 Error code from the API."""
...
class BadRequest(OpenRobotAPIError):
    """Received an 400 Error code from the API."""
...
class InternalServerError(OpenRobotAPIError):
    """Received an 500 Error code from the API."""
...
class TooManyRequests(OpenRobotAPIError):
    """Received an 429 Error code from the API."""
